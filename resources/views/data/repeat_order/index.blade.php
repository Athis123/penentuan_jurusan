    ...
    <div class="row mb-3 align-items-center">
        <div class="col-md-auto mb-2">
            @php
                $user = auth()->user();
            @endphp
            @if ($user->hasRole('admin') || ($user->tim && strtolower($user->tim) === 'crm'))
                <a href="{{ route('admin.data.repeat_order.create') }}" class="btn btn-primary">
                    <i class="fas fa-plus"></i> Tambah Data
                </a>
            @endif
        </div>
        {{-- <div class="col-md-auto mb-2">
            <a href="{{ route('admin.data.repeat_order.export') }}" class="btn btn-success">
...
<script>
    ...
    $(function () {
        ...
        table = $('#table').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ route('admin.data.repeat_order.index') }}',
                data: function (d) {
