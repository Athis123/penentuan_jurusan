...
<div class="section-body">
    <div class="card">
        <div class="card-header">
            <h4>Data Order - {{ $repeadorder->kode }}</h4>
        </div>
        <div class="card-body">
            <table class="table table-bordered">
                ...
                @if($repeadorder->pembayaran != 'cod')
                    <tr>
                        <th>Tanggal Transfer</th>
                        <td>
                            @if($repeadorder->tanggal_tf)
                                {{ \Carbon\Carbon::parse($repeadorder->tanggal_tf)->format('d-m-Y') }}
                            @else
                                -
                            @endif
                        </td>
            ...
            <a href="{{ route('admin.data.repeat_order.index') }}" class="btn btn-secondary mt-2">Kembali</a>
        </div>
    </div>
</div>
@endsection