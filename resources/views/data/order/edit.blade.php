...
@section('content')
    @include('components.breadcrumbs', [
        ...
        'breadcrumbs' => [
            ...
            ['label' => 'Data Order CS', 'url' => route('admin.data.order.index')],
            ['label' => 'Edit']
        ]
    ])
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group date" id="tanggalPicker" data-target-input="nearest">
                            <input type="text" name="tanggal" class="form-control datetimepicker-input" style="border-color: #aaa" value="{{ old('tanggal', $order->tanggal) }}" data-target="#tanggalPicker"/>
                    ...
                    <div class="form-group col-md-4">
                        <label>Nama CS</label>
                        <input type="text" name="nama_cs" class="form-control" style="border-color: #aaa" 
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="adv_id" class="form-control select2">
                            <option value="">-- Pilih --</option>
                            @foreach ($adv as $advp)
                                <option value="{{ $advp->id }}" {{ old('adv_id', $order->adv_id ?? '') == $advp->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" id="qty_produk" name="qty_produk" class="form-control" style="border-color: #aaa"
                    ...
                    <div class="form-group col-md-4">
                        <label>No. HP</label>
                        <input type="text" name="no_hp" class="form-control" style="border-color: #aaa" value="{{ old('no_hp', $order->no_hp) }}">
                    </div>

                    <div class="form-group col-md-12">
                        <label>Alamat</label>
                        <textarea name="alamat" class="form-control" style="border-color: #aaa" rows="2">{{ old('alamat', $order->alamat) }}</textarea>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="ekpedisi" class="form-control select2">
                            ...
                            <option value="jnt" {{ old('ekpedisi', $order->ekpedisi) == 'jnt' ? 'selected' : '' }}>JNT</option>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="total_pembayaran" id="total_pembayaran" class="form-control" style="border-color: #aaa"
                    ...
                    <div class="form-group col-md-4" id="tanggalTfGroup">
                        ...
                        <div class="input-group date" id="tanggalTf" data-target-input="nearest">
                            <input 
                                type="text" 
                                name="tanggal_tf" 
                                class="form-control datetimepicker-input" style="border-color: #aaa" 
                                value="{{ old('tanggal_tf', optional($order->tanggal_tf)->format('d-m-Y')) }}" 
                                data-target="#tanggalTf"
                            />
...
@push('scripts')
<script>
    const provinsiOld   = @json(old('provinsi', $order->provinsi));
    const kabupatenOld  = @json(old('kabupaten', $order->kabupaten));
    const kecamatanOld  = @json(old('kecamatan', $order->kecamatan));
    const kelurahanOld  = @json(old('kelurahan', $order->kelurahan));
    const kodePosOld    = @json(old('kode_pos', $order->kode_pos));
</script>
