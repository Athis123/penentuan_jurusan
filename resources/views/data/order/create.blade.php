                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group date" id="tanggalPicker" data-target-input="nearest">
                            <input type="text" name="tanggal" class="form-control datetimepicker-input" data-target="#tanggalPicker" style="border-color: #aaa"/>
                    ...
                    <div class="form-group col-md-4">
                        <label>Nama CS</label>
                        <input type="text" name="nama_cs" class="form-control" style="border-color: #aaa" required>
                    </div>
                    ...
                    <div class="form-group col-md-4" id="buktiTfGroup">
                        ...
                        <input type="file" name="bukti_tf" class="form-control-file border">
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#provinsi').select2({ width: '100%', placeholder: 'Pilih Provinsi' });
        $('#kabupaten').select2({ width: '100%', placeholder: 'Pilih Kabupaten' });
        $('#kecamatan').select2({ width: '100%', placeholder: 'Pilih Kecamatan' });
        $('#kelurahan').select2({ width: '100%', placeholder: 'Pilih Kelurahan' });
